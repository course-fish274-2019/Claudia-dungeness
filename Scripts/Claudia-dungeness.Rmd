...
A new dataframe is created containing the regression line points from the area 11 linear model previous conducted.
...
A new dataframe is created containing the regression line points from the area 13 linear model previous conducted.
...
A new dataframe is created containing the R^2 value from the area 11 linear model previously conducted.
